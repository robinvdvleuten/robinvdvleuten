...
- [robinvdvleuten/lezer-beancount](https://github.com/robinvdvleuten/lezer-beancount) ([v1.1.0](https://github.com/robinvdvleuten/lezer-beancount/releases/tag/v1.1.0), 2 days ago) - Beancount grammar for the lezer parser system
- [webpro-nl/knip](https://github.com/webpro-nl/knip) ([5.71.0](https://github.com/webpro-nl/knip/releases/tag/5.71.0), 6 days ago) - ✂️  Find unused files, dependencies and exports in your JavaScript and TypeScript projects. Knip it before you ship it!
...
- [feat: add support for beancount grammar to codemirror](https://github.com/robinvdvleuten/beancount/pull/79) on [robinvdvleuten/beancount](https://github.com/robinvdvleuten/beancount) (6 days ago)
