...
- [remix-run/react-router](https://github.com/remix-run/react-router) ([react-router@7.3.0](https://github.com/remix-run/react-router/releases/tag/react-router%407.3.0), 1 day ago) - Declarative routing for React
