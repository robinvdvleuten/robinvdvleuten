...
- [remix-run/react-router](https://github.com/remix-run/react-router) ([react-router@7.1.4](https://github.com/remix-run/react-router/releases/tag/react-router%407.1.4), 1 day ago) - Declarative routing for React
