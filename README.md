...
- [robinvdvleuten/json-from-script](https://github.com/robinvdvleuten/json-from-script) - 👮🏻 Tiny JSON parser for your CSP aware script tags. (2 weeks ago)
...
- [mijnverbruik/dsmr](https://github.com/mijnverbruik/dsmr) ([v1.0.0](https://github.com/mijnverbruik/dsmr/releases/tag/v1.0.0), 2 days ago) - A library for parsing Dutch Smart Meter Requirements (DSMR) telegram data
- [webpro-nl/knip](https://github.com/webpro-nl/knip) ([5.64.2](https://github.com/webpro-nl/knip/releases/tag/5.64.2), 2 days ago) - ✂️  Find unused files, dependencies and exports in your JavaScript and TypeScript projects. Knip it before you ship it!
