...
- [feat(query): implement bean-query (BQL) with byte parity against beancount v2](https://github.com/robinvdvleuten/beancount/pull/290) on [robinvdvleuten/beancount](https://github.com/robinvdvleuten/beancount) (1 day ago)
- [chore(main): release 0.11.0](https://github.com/robinvdvleuten/beancount/pull/289) on [robinvdvleuten/beancount](https://github.com/robinvdvleuten/beancount) (2 days ago)
- [Add Brevo driver support](https://github.com/spatie/laravel-newsletter/pull/350) on [spatie/laravel-newsletter](https://github.com/spatie/laravel-newsletter) (4 days ago)
