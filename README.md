...
- [remix-run/react-router](https://github.com/remix-run/react-router) ([react-router@7.3.0](https://github.com/remix-run/react-router/releases/tag/react-router%407.3.0), 4 days ago) - Declarative routing for React
...
- [feat: Replace participle with PEG grammar for parsing](https://github.com/robinvdvleuten/beancount/pull/22) on [robinvdvleuten/beancount](https://github.com/robinvdvleuten/beancount) (9 months ago)
