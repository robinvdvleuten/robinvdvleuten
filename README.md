...
- [remix-run/react-router](https://github.com/remix-run/react-router) ([react-router@6.26.2](https://github.com/remix-run/react-router/releases/tag/react-router%406.26.2), 1 day ago) - Declarative routing for React
- [statamic/cms](https://github.com/statamic/cms) ([v5.24.0](https://github.com/statamic/cms/releases/tag/v5.24.0), 1 week ago) - The core Laravel CMS Composer package
