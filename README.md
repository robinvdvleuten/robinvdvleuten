...
- [webstronauts/ex_dsmr](https://github.com/webstronauts/ex_dsmr) - A library for parsing Dutch Smart Meter Requirements (DSMR) telegram data (3 days ago)
...
- [mijnverbruik/dsmr](https://github.com/mijnverbruik/dsmr) ([v0.1.0](https://github.com/mijnverbruik/dsmr/releases/tag/v0.1.0), 1 day ago) - A parser for DSMR telegram data in Go
