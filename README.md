...
- [remix-run/react-router](https://github.com/remix-run/react-router) ([react-router@7.1.2](https://github.com/remix-run/react-router/releases/tag/react-router%407.1.2), 1 day ago) - Declarative routing for React
