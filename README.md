...
- [mijnverbruik/dsmr](https://github.com/mijnverbruik/dsmr) ([v0.4.0](https://github.com/mijnverbruik/dsmr/releases/tag/v0.4.0), 6 days ago) - A library for parsing Dutch Smart Meter Requirements (DSMR) telegram data
- [statamic/cms](https://github.com/statamic/cms) ([v4.53.2](https://github.com/statamic/cms/releases/tag/v4.53.2), 6 days ago) - The core Laravel CMS Composer package
...
- [Rewrite library to use yecc](https://github.com/mijnverbruik/dsmr/pull/26) on [mijnverbruik/dsmr](https://github.com/mijnverbruik/dsmr) (6 days ago)
