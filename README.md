...
- [robinvdvleuten/json-from-script](https://github.com/robinvdvleuten/json-from-script) ([v3.1.0](https://github.com/robinvdvleuten/json-from-script/releases/tag/v3.1.0), 1 day ago) - 👮🏻 Tiny JSON parser for your CSP aware script tags.
- [webpro-nl/knip](https://github.com/webpro-nl/knip) ([5.72.0](https://github.com/webpro-nl/knip/releases/tag/5.72.0), 1 day ago) - ✂️  Find unused files, dependencies and exports in your JavaScript and TypeScript projects. Knip it before you ship it!
- [robinvdvleuten/lezer-beancount](https://github.com/robinvdvleuten/lezer-beancount) ([v1.1.0](https://github.com/robinvdvleuten/lezer-beancount/releases/tag/v1.1.0), 4 days ago) - Beancount grammar for the lezer parser system

#### 🔨 Latest Pull Requests I published

- [chore: bootstrap releases for path: .](https://github.com/robinvdvleuten/beancount/pull/82) on [robinvdvleuten/beancount](https://github.com/robinvdvleuten/beancount) (1 day ago)
