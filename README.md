...
- [feat(plugins): mark size-limit presets as used from the manifest](https://github.com/fallow-rs/fallow/pull/2413) on [fallow-rs/fallow](https://github.com/fallow-rs/fallow) (3 days ago)
