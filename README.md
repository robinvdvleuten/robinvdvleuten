...
- [remix-run/react-router](https://github.com/remix-run/react-router) ([react-router@7.4.1](https://github.com/remix-run/react-router/releases/tag/react-router%407.4.1), 1 day ago) - Declarative routing for React
