...
- [webpro-nl/knip](https://github.com/webpro-nl/knip) ([knip@5.82.1](https://github.com/webpro-nl/knip/releases/tag/knip%405.82.1), 1 day ago) - ✂️  Find unused files, dependencies and exports in your JavaScript and TypeScript projects. Knip it before you ship it!
- [robinvdvleuten/beancount](https://github.com/robinvdvleuten/beancount) ([v0.8.0](https://github.com/robinvdvleuten/beancount/releases/tag/v0.8.0), 6 days ago) - Fast, lightweight Beancount parser, formatter and editor written in Go
...
- [feat(web): auto reload on changes through --watch flag](https://github.com/robinvdvleuten/beancount/pull/121) on [robinvdvleuten/beancount](https://github.com/robinvdvleuten/beancount) (4 days ago)
- [chore(main): release 0.9.0](https://github.com/robinvdvleuten/beancount/pull/120) on [robinvdvleuten/beancount](https://github.com/robinvdvleuten/beancount) (4 days ago)
