...
- [robinvdvleuten/sjabloon](https://github.com/robinvdvleuten/sjabloon) ([v0.4.0](https://github.com/robinvdvleuten/sjabloon/releases/tag/v0.4.0), 1 day ago) - Tiny, CSP-safe template engine for JavaScript
- [robinvdvleuten/xprsn](https://github.com/robinvdvleuten/xprsn) ([v0.4.0](https://github.com/robinvdvleuten/xprsn/releases/tag/v0.4.0), 1 day ago) - Tiny and CSP-safe expression language for JavaScript
- [robinvdvleuten/shvl](https://github.com/robinvdvleuten/shvl) ([v3.0.1](https://github.com/robinvdvleuten/shvl/releases/tag/v3.0.1), 2 days ago) - Get and set dot-notated properties within an object.

#### 🔨 Latest Pull Requests I published

- [chore(main): release 0.2.1](https://github.com/robinvdvleuten/padvinder/pull/4) on [robinvdvleuten/padvinder](https://github.com/robinvdvleuten/padvinder) (today)
