...
- [remix-run/react-router](https://github.com/remix-run/react-router) ([react-router@7.1.5](https://github.com/remix-run/react-router/releases/tag/react-router%407.1.5), 3 days ago) - Declarative routing for React
