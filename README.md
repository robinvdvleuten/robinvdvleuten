...
- [remix-run/react-router](https://github.com/remix-run/react-router) ([react-router@7.6.0](https://github.com/remix-run/react-router/releases/tag/react-router%407.6.0), 3 days ago) - Declarative routing for React
- [webpro-nl/knip](https://github.com/webpro-nl/knip) ([5.55.1](https://github.com/webpro-nl/knip/releases/tag/5.55.1), 3 days ago) - ✂️  Find unused files, dependencies and exports in your JavaScript and TypeScript projects. Knip it before you ship it!
