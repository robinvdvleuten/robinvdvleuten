...
- [statamic/cms](https://github.com/statamic/cms) ([v5.42.0](https://github.com/statamic/cms/releases/tag/v5.42.0), 2 days ago) - The core Laravel CMS Composer package
- [remix-run/react-router](https://github.com/remix-run/react-router) ([react-router@7.0.2](https://github.com/remix-run/react-router/releases/tag/react-router%407.0.2), 4 days ago) - Declarative routing for React
