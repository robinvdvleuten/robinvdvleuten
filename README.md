...
- [statamic/cms](https://github.com/statamic/cms) ([v5.39.0](https://github.com/statamic/cms/releases/tag/v5.39.0), 1 day ago) - The core Laravel CMS Composer package
- [remix-run/react-router](https://github.com/remix-run/react-router) ([react-router@7.0.1](https://github.com/remix-run/react-router/releases/tag/react-router%407.0.1), 1 day ago) - Declarative routing for React
- [statamic/statamic](https://github.com/statamic/statamic) ([v5.0.10](https://github.com/statamic/statamic/releases/tag/v5.0.10), 3 days ago) - Statamic: The New Site/App Package
